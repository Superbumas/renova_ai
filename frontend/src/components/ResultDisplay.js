  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1800px] mx-auto px-6 py-8">
        ...
        <div className="glass-effect rounded-3xl p-8 mb-8 border border-white/20">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <button
                onClick={shareResult}
                className="glass-effect px-6 py-3 rounded-xl border border-white/20 hover:bg-white/30 transition-all duration-300 flex items-center space-x-2 group"
              >
        ...
        {/* Main Content Grid - Extra Wide Layout */}
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-8">
          ...
          <div className="xl:col-span-3 space-y-6">
            ...
            <div className="glass-effect rounded-2xl p-6 border border-white/20">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center bg-white/50 rounded-xl p-1 backdrop-blur-sm">
                  <button
              ...
              <div className="relative group">
                <div className="aspect-[16/10] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-slate-100 to-slate-200">
                  {compareMode ? (
                    ...
                    <div className="relative w-full h-full">
                      ...
                      <button
                        ...
                        className="absolute top-4 right-4 glass-effect p-3 rounded-xl border border-white/20 opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white/30"
                      >
          ...
          <div className="xl:col-span-2 space-y-6">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-4 text-sm font-medium transition-all duration-300 ${
                      activeTab === tab.id
                        ? 'bg-white/20 text-slate-800 border-b-2 border-blue-500'
                        ...
                        <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-xl border border-slate-200">
                          ...
                          <div className="grid gap-3">
                            <div className="flex justify-between items-center py-2 border-b border-slate-200 last:border-b-0">
                              ...
                              <span className="font-mono text-slate-800 bg-slate-200 px-2 py-1 rounded text-sm">
                                {result.job_id?.substring(0, 8) || 'N/A'}
                              </span>
                            </div>
                            <div className="flex justify-between items-center py-2 border-b border-slate-200 last:border-b-0">
                          ...
                          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-200">
                            ...
                            <div className="space-y-3">
                              <div className="flex justify-between items-center">
                                ...
                                <span className="text-blue-900 font-semibold">{result.model.name}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                ...
                                <span className="px-2 py-1 bg-blue-200 text-blue-800 rounded-full text-sm font-semibold">
                                  {result.model.cost_per_generation}
                                </span>
                              </div>
                            </div>
                          </div>
            ...
            <div className="glass-effect rounded-2xl p-6 border border-white/20">
              ...
              <div className="grid gap-3">
                <button className="w-full p-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl hover:from-emerald-600 hover:to-teal-600 transition-all duration-300 flex items-center justify-center space-x-2 group">
                  <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button className="w-full p-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 flex items-center justify-center space-x-2 group">
                  <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                  onClick={onReset}
                  className="w-full p-4 glass-effect border border-white/20 text-slate-700 rounded-xl hover:bg-white/30 transition-all duration-300 flex items-center justify-center space-x-2 group"
                >
                  <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {isFullscreen && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4">
          <button
            onClick={toggleFullscreen}
            className="absolute top-6 right-6 glass-effect p-3 rounded-xl border border-white/20 text-white hover:bg-white/10 transition-all z-10"
          >
